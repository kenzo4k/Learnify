...
const sampleDashboard = {
  ...
  recentActivity: [
    ...
    {
      action: "Earned 100 XP",
      course: "Completed JavaScript Advanced",
      time: "3 days ago",
      icon: "🏆",
      xp: 100,
    },
...
const Student = () => {
  ...
  const handleCourseClick = (courseId) => {
    // Navigate to your learning page where the Monaco Editor lives
    navigate(`/course/${courseId}/exercise`);
  };
              ...
              <div className="bg-gray-800 rounded-xl border border-gray-700 p-6">
                ...
                <div className="space-y-3">
                  {deadlines.map((deadline, index) => (
                    <div
                      key={index}
                      className={`flex items-center justify-between p-4 rounded-lg border transition-colors ${getDeadlineColor(
                        deadline.daysLeft
                      )}`}
                    >
                      ...
                      <div key={day} className="flex items-center space-x-3">
                        ...
                        <div className="flex-1 bg-gray-600 rounded-full h-3">
                          <div
                            ...
                            style={{
                              width: `${[65, 80, 45, 90, 70, 30, 50][i]}%`,
                            }}
                          />
                        </div>
                        <span className="text-sm text-gray-300 w-12">
                          {" "}
                          {[2.5, 3, 2, 3.5, 2.8, 1.2, 2][i]}h
                        </span>
                      </div>
                    )
                  )}
              ...
              <div className="bg-gray-700 p-6 rounded-lg">
                ...
                <div className="grid grid-cols-3 gap-4">
                  {[
                    ...
                    <div
                      key={i}
                      className="text-center p-4 bg-gray-600 rounded-lg"
                    >
