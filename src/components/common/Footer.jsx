      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="px-6 py-12 border-b border-gray-800 flex flex-col lg:flex-row justify-between items-center gap-8 bg-gray-800/50 rounded-xl my-8">
          ...
          >
            ...
            <button
              type="submit"
              className="px-6 py-3 bg-cyan-600 hover:bg-cyan-700 rounded-lg font-medium text-white transition-all duration-300"
            >
              Subscribe
            </button>
          </form>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 py-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/my-enrolled-courses" className="text-gray-400 hover:text-cyan-400 transition-colors">My Enrolled Courses</Link></li>
            </ul>
          </div>
